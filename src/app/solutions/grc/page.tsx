  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative h-[320px] md:h-[400px] w-[750px] md:w-[1920px] max-w-full bg-[#0a192f] flex items-center justify-start mx-auto">
        <Image
          src="/images/solutions/solution-pages/hero-gov-risk-desktop.webp"
          alt="Governance, Risk & Compliance Hero"
          fill
          className="object-cover hidden md:block"
          priority
        />
        <Image
          src="/images/solutions/solution-pages/hero-gov-risk-mobile.webp"
          alt="Governance, Risk & Compliance Hero"
          fill
