<section className="relative h-[500px] md:h-[600px] flex items-center">
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="max-w-3xl">
      <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Cloud Infrastructure Services</h1>
      <p className="text-xl text-white mb-8">Transform your business with our comprehensive cloud infrastructure solutions, ensuring scalability, security, and performance.</p>
