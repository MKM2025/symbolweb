  ...
  return (
    <section className="relative w-full h-screen min-h-screen max-h-screen overflow-hidden -mt-[1px] mb-0">
      ...
      <div className="relative h-full container mx-auto px-4 flex flex-col justify-center portrait:justify-start portrait:pt-16 landscape:items-start md:absolute md:top-[25%] md:px-4 md:justify-start md:pt-0">
        <div className="max-w-3xl md:max-w-4xl ml-0 md:ml-12 pl-4 sm:pl-8 portrait:ml-6 portrait:mt-0 landscape:mt-8 lg:mt-[-180px] portrait:items-start portrait:text-left portrait:pr-8">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false, amount: 0.6 }}
            transition={{ duration: 0.8, ease: 'easeOut' }}
            className="text-2xl sm:text-4xl md:text-6xl landscape:!text-[min(4.5vw,3rem)] font-bold text-[#FFF9C4] mb-2 sm:mb-4 md:mb-4 landscape:mb-3 drop-shadow-lg landscape:leading-tight max-w-2xl md:max-w-3xl landscape:text-left"
          >
            Latest Insights
          </motion.h1>
          <motion.h2
            ...
            className="text-lg sm:text-2xl md:text-3xl text-[#FFF9C4] mb-2 sm:mb-3 md:mb-4 drop-shadow-md landscape:max-w-[90%] max-w-2xl md:max-w-3xl landscape:text-left font-semibold"
          >
          ...
          <motion.p
            ...
            className="italic text-base sm:text-lg md:text-xl text-[#FFF9C4] mb-4 sm:mb-6 md:mb-8 landscape:mb-4 drop-shadow-md landscape:max-w-[90%] max-w-2xl md:max-w-3xl landscape:text-left"
          >
            Stay informed with our latest projects, strategies, and innovations powering intelligent change across industries.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
