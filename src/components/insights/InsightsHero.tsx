    ...
    <section className="relative w-full min-h-[400px] aspect-[3/4] sm:aspect-[3/2] md:aspect-[32/15] max-h-screen md:max-h-[900px] landscape:aspect-[32/15] landscape:min-h-[300px] -mt-[1px] mb-0">
      ...
      <div className="relative h-full container mx-auto px-4 flex flex-col justify-center portrait:justify-start portrait:pt-16 landscape:items-start">
        <div className="max-w-2xl ml-0 pl-4 sm:pl-8 portrait:ml-6 portrait:mt-0 landscape:mt-8 md:mt-[-150px] landscape:max-w-[45%] landscape:ml-4">
          <h1 className="text-2xl sm:text-3xl md:text-5xl landscape:!text-[min(4vw,2.5rem)] font-bold text-[#0a2a4a] mb-2 sm:mb-4 md:mb-6 landscape:mb-3 drop-shadow-lg landscape:leading-tight landscape:text-left">
            AI-Driven Cybersecurity & ICT Solutions
          </h1>
          <p className="text-base sm:text-lg md:text-xl landscape:!text-[min(2vw,1rem)] text-[#0a2a4a] mb-4 sm:mb-6 md:mb-8 landscape:mb-4 drop-shadow-md landscape:max-w-[90%] landscape:text-left">
          ...
          <div className="flex flex-col sm:flex-col portrait:flex-row portrait:gap-3 flex-wrap landscape:flex-row landscape:gap-4">
            ...
            <Link 
              href="/insights/blogs"
              className="w-auto sm:w-48 landscape:w-auto landscape:px-6 landscape:!text-[min(1.8vw,0.875rem)] bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] text-[#0a2a4a] px-4 py-2 rounded-lg hover:from-[#FCF6BA] hover:via-[#B38728] hover:to-[#BF953F] transition-all duration-300 font-semibold shadow-md text-base text-center"
            >
              Latest Insights
            </Link>
          </div>
